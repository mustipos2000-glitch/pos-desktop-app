            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-lg font-semibold text-pos-text-primary mb-3">
                      Start Date
                    </label>
                    <input
                      type="date"
              ...
              <div className="flex items-center gap-4">
                <div className="flex-1 h-0.5 bg-pos-border-primary"></div>
                <svg className="w-8 h-8 text-pos-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
